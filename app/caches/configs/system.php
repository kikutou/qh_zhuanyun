...
'cookie_pre' => 'Nmcrh_', //Cookie 前缀，同一域名下安装多套系统时，请修改Cookie前缀
'cookie_ttl' => 0, //Cookie 生命周期，0 表示随浏览器进程

'js_path' => '/app/resource/js/', //CDN JS
'css_path' => '/app/resource/css/', //CDN CSS
'img_path' => '/app/resource/images/', //CDN img
'upload_path' => PHPCMS_PATH.'uploadfile/', //上传文件路径
'app_path' => '/app/',//动态域名配置地址
...
'errorlog' => 0, //是否保存错误日志
'gzip' => 1, //是否Gzip压缩后输出
'auth_key' => 'CN7VyrW5WyLNWmtst9BO', // //Cookie密钥
'lang' => 'zh-cn',  //网站语言包
...
'uc_appid'=>'2',//应用id(APP ID)
'uc_key'=>'408h4ww1vj15feczv4qhzboodx3526ra',//Ucenter 通信密钥
);
?>
